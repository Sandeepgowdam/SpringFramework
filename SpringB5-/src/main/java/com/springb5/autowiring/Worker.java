...
public class Worker {
	...
	@Autowired
	@Qualifier("a2")  // when we are using the concept of autowiring at thet time when we give more then one bean then we need to
                           //  assign the required bean name with qualifers
